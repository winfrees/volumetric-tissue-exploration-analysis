...
/**
 * Exception thrown when object segmentation operations fail.
 *
 * This includes failures in detecting, separating, or measuring objects
 * within images.
 *
 * @author VTEA Development Team
 */
public class SegmentationException extends VTEAException {
